				...
				<Fade duration={500}>
					<div className="container my-5">
						<Alert variant="success">
							...
							<h4 className="text-center">
								DSA helps you to build your confidence in solving any coding <br /> related question and helps you
					...
					<div className="container my-5">
						<h2 className="text-center">
							<a href="#">MY DSA</a> is your personal web-based progress tracker based on <br></br>
							<i>
								<a
							...
							Questions from various plateforms like GFG and Leetcode
								
							by{" "}
							<b>
								<a href="https://www.linkedin.com/in/adarsh-tiwari-b29209160/" target="_blank" rel="noopener noreferrer">
									Adarsh Tiwari
								</a>
							</b>{" "}
